...
function DataFiltering ({tableName , data, handleSearch, filterByDateCreated, findByAccountStatus, setReload}) {
    const [accountType, setAccountType] = useState("accountno");
    ...
    const submitSearch = (e) => {
        ...
        if(searchInput.trim() !== ""){
            setValidate(false)
            handleSearch(accountType, searchInput)
        }else{
            setValidate(true)
            setSearchInput("");
        }
                ...
                <div className="d-flex">
                    ...
                    <div className="dropdown input-group-item">
                        ...
                        <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            <li><div className="dropdown-item" data-tag="name" onClick={changeSearchType} >Name</div></li>
                            <li><div className="dropdown-item" data-tag="phone" onClick={changeSearchType} >phone</div></li>
                        ...
                        <input 
                            ...
                            placeholder={`search by ${accountType === "accountno" ? "account no." : accountType }`}
                            type={'text'}
                            name="search"
                            value={searchInput} 
